    ...
    for (let i = 0; i < allProducts.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allProducts[i].id}"> <img src="${allProducts[i].thumbnail}" alt=""></a>
                </div>
...
function displayPhonesData(){
    ...
    for (let i = 0; i < allPhones.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allPhones[i].id}"> <img src="${allPhones[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displayLaptopsData(){
    ...
    for (let i = 0; i < allLaptops.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allLaptops[i].id}"> <img src="${allLaptops[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displayWatchesData(){
    ...
    for (let i = 0; i < allWatches.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allWatches[i].id}"> <img src="${allWatches[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displayClothesData(){
    ...
    for (let i = 0; i < allClothes.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allClothes[i].id}"> <img src="${allClothes[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displayShoesData(){
    ...
    for (let i = 0; i < allShoes.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allShoes[i].id}"> <img src="${allShoes[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displayFurnitureData(){
    ...
    for (let i = 0; i < allFurniture.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allFurniture[i].id}"> <img src="${allFurniture[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displayAccessoriesData(){
    ...
    for (let i = 0; i < allAccessories.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allAccessories[i].id}"> <img src="${allAccessories[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displayBeautyData(){
    ...
    for (let i = 0; i < allBeauty.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allBeauty[i].id}"> <img src="${allBeauty[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displaySportsData(){
    ...
    for (let i = 0; i < allSports.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allSports[i].id}"> <img src="${allSports[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
...
function displayGroceryData(){
    ...
    for (let i = 0; i < allGrocery.length; i++) {
        x+=`<div class="product-page-card">
                <div class="product-page-card-img">
                   <a href="http://127.0.0.1:5501/singleProduct.html?id=${allGrocery[i].id}"> <img src="${allGrocery[i].thumbnail}" alt=""></a>
                </div>
                <div class="product-page-card-title">
